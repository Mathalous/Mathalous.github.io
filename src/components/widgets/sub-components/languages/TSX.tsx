...
function TSXInternal (props:GenericNodeProps<ILanguage>){
  ...
  return <div>
    ...
    <p>
      I have come to prefer TS typing more than the typing of other languages. I mostly like that I can inline type information
      and use logical operations to further define, filter, or refine types relative to other types. While I often have to
      go back and clean up my code once I get it working properly, writing the code with inlined types allows me to remember 
      what is required before abstracting to another file.
    </p>
    <TagGroup>
      {otherTags}
    </TagGroup>
